...
export default function AnniversaryPreview() {
  return (
    <div className="min-h-screen bg-brand-background text-brand-text font-body flex flex-col items-center justify-center text-center p-4">
      ...
      <h1 className="font-heading text-4xl md:text-5xl mb-4">Golden Years</h1>
      <p className="text-brand-text/70 max-w-md mx-auto mb-8 leading-relaxed">
        This template is currently being meticulously crafted by our design team. It will feature a sophisticated dark theme with warm gold accents.
      </p>
